...
construct_and_access_kmodule_test() ->
  ...
  Mfa = {some_module, f, 1},
  AST = {c_module,[],
	 {c_literal,[],some_module},
	 [{c_var,[],{f,1}},
	  {c_var,[],{module_info,0}},
	  {c_var,[],{module_info,1}}],
	 [{{c_literal,[1],file},{c_literal,[1],[{"some_module.erl",1}]}}],
	 [{{c_var,[],{f,1}},
	   {c_fun,
	    [{function,{f,1}},4],
	    [{c_var,[4],0}],
	  ...
	  {{c_var,[],{module_info,0}},
	   {c_fun,
	    [{function,{module_info,0}},0],
	    [],
	    {c_call,
	     [0],
	     {c_literal,[0],erlang},
	     {c_literal,[0],get_module_info},
	     [{c_literal,[0],some_module}]}}},
	  {{c_var,[],{module_info,1}},
	   {c_fun,
	    [{function,{module_info,1}},0],
	    [{c_var,[0],0}],
	    {c_call,
	     [0],
	     {c_literal,[0],erlang},
	     ...
	     [{c_literal,[0],some_module},
	      {c_var,
	       [{function,{module_info,1}},0],
	       0}]}}}]},
  Kmodule = cuter_cerl:kmodule(some_module, AST, fun() -> ok end),
