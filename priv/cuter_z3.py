...
class ErlangZ3:
  ...
  def command_toZ3(self, tp, json_data, rev):
    opts_normal = {
      ...
      cc.OP_ERLANG_MINUS_2: self.cmd_erlang_minus_2_to_Z3,
    }
    ...
    opts_rev = {
      ...
      cc.OP_ERLANG_MINUS_2: self.cmd_erlang_minus_2_to_Z3_RV,
    }
  ...
  def cmd_erlang_minus_2_to_Z3(self, term, term1, term2):
    T = self.Term
    s = term["s"]
    t1 = self.term_toZ3(term1)
    t2 = self.term_toZ3(term2)
  ...
  # (Reversed)
  def cmd_erlang_minus_2_to_Z3_RV(self, term, term1, term2):
    T = self.Term
    t1 = self.term_toZ3(term1)
    t2 = self.term_toZ3(term2)
    self.axs.append(
